...
router.get(
    ...
    async (req, res, next) => {
        ...
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 500;
        const serviceResponse = await service.getAllStudentFeesData(
            groupId,
            criteria,
            page,
            limit
...
router.get(
    ...
    async (req, res, next) => {
        ...
        const serviceResponse = await service.getAllFeesCount(
            groupId,
            criteria
        );
        requestResponsehelper.sendResponse(res, serviceResponse);
